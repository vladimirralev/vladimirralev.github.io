...
class SpeechAnalyzer {
    ...
    drawSpectrum() {
        ...
        const voiceprintWidth = (this.spectrumWidth * 2) - 200; // Reserve 200 pixels (100px wide at 2x resolution) for sidebar
        ...
        // Draw a test rectangle across the canvas to confirm context functionality
        //this.spectrumCtx.fillStyle = 'rgba(0, 255, 0, 0.5)';
        //this.spectrumCtx.fillRect(50, 50, 100, 100);
        
        // Draw live spectral analysis sidebar on the right
    ...
    drawLiveSpectrumSidebar(voiceprintWidth, maxFreq, maxBin, binHeight, latestFormants) {
        ...
        //this.spectrumCtx.lineTo(sidebarStartX + sidebarWidth, this.spectrumHeight);
        //this.spectrumCtx.lineTo(sidebarStartX + sidebarWidth, 0);
        //this.spectrumCtx.lineTo(sidebarStartX, 0);
        this.spectrumCtx.stroke();
